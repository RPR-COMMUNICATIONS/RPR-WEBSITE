...
/**
 * TS-Λ3 // OVERWATCH COMMAND AXIS [v6.8.0]
 * Path: src/components/overwatch.tsx
 * Mission: Narrative Readability // Manifesto Pill Removal
...
// ♟️ UI PRIMITIVE: CHECKMATE BOARD
const CheckmateBoard: React.FC = () => {
  ...
  const BlackRook = () => (
    <div className="w-3 h-3 bg-cyan-500 rounded-[2px] shadow-[0_0_10px_rgba(34,211,238,0.9)]" />
  );
  const BlackKing = () => (
    <div className="w-3.5 h-3.5 rounded-full border-2 border-cyan-400 shadow-[0_0_12px_rgba(34,211,238,1)]" />
  );
  const BlackBishop = () => (
    <div className="w-0 h-0 border-l-[6px] border-l-transparent border-r-[6px] border-r-transparent border-b-[12px] border-b-cyan-400 shadow-[0_0_10px_rgba(34,211,238,0.9)]" />
  );
  const BlackKnight = () => (
    <div className="w-4 h-4 bg-cyan-400/20 border border-cyan-400 rotate-45 shadow-[0_0_14px_rgba(34,211,238,1)]" />
  );
  const BlackPawn = () => (
    <div className="w-2 h-2 rounded-full bg-cyan-500 shadow-[0_0_8px_rgba(34,211,238,0.9)]" />
  );
  const WhiteKing = () => (
    <div className="w-3.5 h-3.5 rounded-full bg-white shadow-[0_0_14px_rgba(255,255,255,1)]" />
  );
  const WhiteQueen = () => (
    <div className="w-3.5 h-3.5 bg-white rotate-45 shadow-[0_0_14px_rgba(255,255,255,1)]" />
  );
  ...
  return (
    <div className="relative w-full aspect-square max-w-[340px] mx-auto overflow-hidden rounded-2xl border border-white/10 bg-black/40 shadow-2xl group">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,#0f172a_0,#020617_55%,#000000_100%)]">
        ...
        <div className="absolute inset-0 bg-[linear-gradient(to_bottom,rgba(15,23,42,0)_0,rgba(15,23,42,0.7)_50%,rgba(15,23,42,0)_100%)] bg-[size:100%_6px] mix-blend-soft-light opacity-40 pointer-events-none" />
      </div>
      <div className="relative flex items-center justify-center w-full h-full">
        <svg viewBox="0 0 500 500" className="w-[85%] h-[85%] rotate-12 overflow-visible">
          ...
          <circle
            ...
            r={9}
            fill="#22d3ee"
            style={{ filter: 'drop-shadow(0 0 14px rgba(34,211,238,1))' }}
          />
          <rect
            x="120"
            y="120"
            ...
            fill="#e5e7eb"
            rx="2"
            style={{ filter: 'drop-shadow(0 0 10px rgba(229,231,235,0.9))' }}
          />
          <polygon
            points="350,120 366,148 334,148"
            fill="#e5e7eb"
            style={{ filter: 'drop-shadow(0 0 10px rgba(229,231,235,0.9))' }}
          />
      ...
      <div className="absolute inset-x-3 bottom-3 flex items-center justify-between text-[8px] font-mono uppercase tracking-widest text-slate-500">
        ...
        <span>
          Integrity: <span className="text-cyan-400">98.4%</span>
        </span>
      </div>
    </div>
  );
    ...
    <section id="overwatch" className="py-20 md:py-24 relative overflow-hidden bg-black border-t border-white/5">
      ...
      <div className="max-w-screen-2xl mx-auto px-6 relative z-10">
        ...
        <div className="mb-10 flex items-end justify-between gap-8">
          ...
          <div className="hidden md:block px-4 py-2 bg-white/5 border border-white/10 rounded-2xl backdrop-blur-md">
            <p className="font-mono text-[8px] text-slate-500 uppercase tracking-[0.4em]">
              SYSTEM_STATUS:{' '}
              <span className="text-cyan-500 font-black animate-pulse">LATCHED_PRIMARY</span>
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 lg:grid-rows-2 divide-white/10 lg:divide-x lg:divide-y-0">
            ...
            <div className="border-b lg:border-b border-white/10 p-8 md:p-12 flex flex-col justify-between bg-black/20">
              <div className="space-y-10">
                <div className="flex items-start gap-8">
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="flex gap-4 pt-3">
                      ...
                      <a href="https://substack.com/@butterdime" target="_blank" rel="noreferrer">
                        <BookOpen
                          size={14}
                ...
                {/* Readable narrative block */}
                <div className="space-y-4 text-slate-300 text-sm md:text-base leading-relaxed pr-4">
                  <p>
                    {t(
                      'overwatch.bio_p1',
                  ...
                  <p className="text-slate-400 border-l border-white/10 pl-4">
                    {t(
                      'overwatch.bio_p2',
                      'While experimenting with Artificial Intelligence for his own personal writings and ideas, a pattern he noticed in a client problem raised a different question: how can a sentient being leverage an artificial construct to apply its knowledge in knowledge discovery, systems thinking, and polymathic research—within the same human framework of systems and silos—to create something better?',
                    )}
                  </p>
                </div>
              </div>
              <div className="mt-12 pt-6 border-t border-white/5">
                <TacticalProgress label="IDENTITY_LATCHED" />
              </div>
            </div>

            {/* ♟️ QUADRANT 2: CHESSBOARD */}
            <div className="border-b border-white/10 p-8 md:p-12 flex flex-col items-center justify-center bg-black/40 group/axis1">
              <div className="w-full space-y-8">
                <div className="flex items-center gap-4 opacity-30 group-hover/axis1:opacity-60 transition-opacity">
                  <span className="text-[8px] font-mono text-white uppercase tracking-[0.5em] font-black">
                    Axis_01 // Forensic_Board
                  </span>
              ...
              <div className="space-y-8">
                <header className="space-y-2">
                  <div className="flex items-center gap-2 opacity-40">
                    ...
                    <span className="text-[7px] font-mono text-cyan-500 tracking-[0.5em] uppercase font-black">
                      Axis_02 // Narrative
                    </span>
                  </div>
        ...
        <div className="mt-12 flex justify-between items-center opacity-10 select-none font-mono text-[7px] uppercase tracking-[0.8em]">
          <span>SG-CANONICAL-2026 // OVERWATCH_v6.8.0</span>
