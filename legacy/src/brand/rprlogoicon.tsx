...
/**
 * TS-Λ3 // RPR LOGO ICON [v1.1.0]
 * Path: src/brand/rprlogoicon.tsx
 * Mission: Minimalist Shield Icon for UI Navigation Handshakes.
 * Authority: THE OVERWATCH // SG-CANONICAL-2026
 */

interface RprLogoIconProps {
    size?: number;
    className?: string;
}

export const RprLogoIcon: React.FC<RprLogoIconProps> = ({
    size = 24,
    className = ''
}) => {
    return (
